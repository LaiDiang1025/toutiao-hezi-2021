<template>
    <div>
        ...
        <div style="padding-bottom:20px" class="action-head">
            ...
            <el-button size="mini" type="success" round @click= "dialogUploadVisible = true">上传素材</el-button>        
        </div>

        <!-- 素材列表 -->
        <el-row :gutter= "10"> 
            <el-col :span= "4" :xs= "12" :sm= "6" :md= "6" :lg= "4" v-for= "(img,index) in images" :key= "index" class="image-item"><el-image style="height: 100px" :src= "img.url" fit= "cover"></el-image>
            <!-- 图片操作 -->
    ...
    <el-dialog title="上传素材" :visible.sync= "dialogUploadVisible" :append-to-body='true' width="150">
